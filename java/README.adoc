...
Consider creating a dedicated profile (with a name like “Yseop”) in the formatter’s settings to be able to reconfigure it faster.
...
- Go to menu:File[Settings > Other settings > Eclipse code formatter],
