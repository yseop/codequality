...
* Go to menu:Java Code Style[Formatter], and make sur the btn:[Enable project specific settings] box is *_not_* checked.
...
* Then tick the btn:[Format source code] box, and make sur the btn:[Format all lines] option is selected.
...
* Make sur the btn:[Number of imports needed for .\*] and btn:[Number of static imports needed for .*] are set to{nbsp}99.
* Apply and close.

To make sure the imports organization will be the same for each of your project:

* Right click on a project's root folder, select btn:[Properties].
* Go to menu:Java Code Style[Organize Imports], and make sur the btn:[Enable project specific settings] box is *_not_* checked.
